...
export default function CartPage() {
  ...
  if (!items.length) {
    return (
      <ProtectedRoute>
        <div className="min-h-screen bg-base-100 flex flex-col items-center justify-center text-center px-4 transition-colors duration-300">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-5">
              {items.map((item) => (
                <div
                  key={item.bookId}
                  className="bg-base-100 border border-base-200 rounded-3xl p-5 shadow-sm hover:shadow-md transition-all duration-300"
                >
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <button
                      ...
                      className="btn btn-ghost btn-circle text-error self-start hover:bg-error/10"
                    >
            ...
            <div>
              <div className="sticky top-24 bg-base-100 border border-base-200 rounded-3xl p-8 shadow-sm">
                ...
                <div className="space-y-4 text-base">
                  ...
                  <div className="flex justify-between">
                    <span className="text-base-content/70">Vận chuyển</span>
