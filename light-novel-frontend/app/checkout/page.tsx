          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="card bg-base-100 shadow-sm p-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <label className="label"><span className="label-text font-medium">Địa chỉ giao hàng <span className="text-red-500">*</span></span></label>
                  <textarea value={shippingAddress} onChange={(e) => setShippingAddress(e.target.value)} className="textarea textarea-bordered w-full h-28" required />
                </div>
              </div>
            </div>
            ...
            <div className="card bg-base-100 shadow-sm p-8">
              ...
              <div className="space-y-4">
                {/* <label className="flex gap-4 cursor-pointer p-4 border rounded-xl hover:bg-base-200">
                  <input type="radio" checked={paymentMethod === 'cod'} onChange={() => setPaymentMethod('cod')} className="radio radio-primary" />
                  <div>
                ...
                <label className="flex gap-4 cursor-pointer p-4 border rounded-xl hover:bg-base-200">
                  <input type="radio" checked={paymentMethod === 'bank'} onChange={() => setPaymentMethod('bank')} className="radio radio-primary" />
                  <div>
          ...
          <div className="lg:col-span-2">
            <div className="card bg-base-100 shadow-sm p-8 sticky top-24">
                ...
                {items.map((item) => (
                  <div key={item.bookId} className="flex gap-4">
                    <div className="w-16 h-20 relative rounded overflow-hidden">
                      <Image src={item.book.image || "/images/default-book.jpg"} alt="" fill className="object-cover" />
                    </div>
              ...
              {!showQR ? (
                ...
                >
                  {loading ? "Đang xử lý..." : paymentMethod === 'bank' ? "Tạo mã QR thanh toán" : "Xác nhận đặt hàng"}
                </button>
              ) : (
                <div className="mt-8 text-center">
                  ...
                  <p className="text-sm mt-4 text-gray-500">Ngân hàng: MB Bank<br />Số tài khoản: 0329541201</p>
